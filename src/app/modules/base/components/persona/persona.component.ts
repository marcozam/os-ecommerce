...
export class PersonaComponent implements OnInit {
  ...
  @ViewChild('formPersona') form: NgForm;

  private _initialData: Persona;
  @Input()
  get initialData(): Persona{ return this._initialData; }
  ...
  @Output() onChange: EventEmitter<{data: Persona, isValid: boolean}> = new EventEmitter();
