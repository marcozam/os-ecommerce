...
// Models
import { IOSBaseCatalog } from '../../models';
// Notifications
import { WARNING_TITLE, LEAVE_WARNING_MESSAGE, NOTIFICATION_TYPES } from 'application/notifications';
// Services
import { DialogBoxService } from 'app/services/dialog-box.service';

export abstract class OSBaseFormContainer<T extends IOSBaseCatalog> implements OnInit, OnDestroy {
